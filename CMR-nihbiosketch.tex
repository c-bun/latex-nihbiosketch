...
advancement, I moved to the Prescher lab % QUESTION Address the move at some point?
...
\item \textbf{Graduate Career:} My contributions in graduate school I developed new bioluminescent tools for preclinical imagin applications. Bioluminescnt proteins are widely used for monitoring protein expression in a variety of environments. In many cases, bioluminecence is preferred over fluorescence due to its excellent sensitvity \textit{in vivo} and \textit{in vitro}. Instead of an excitation light source, bioluminescent proteins (luciferases) use the energy stored in the chemical bonds of a small molecule substrate (luciferins) to produce photons of light. Because organisms do not normally glow, as few as one cell can be visualized in a living mouse. Unlike fluorescent probes, however, current bioluminecent tools lack the ability to track multiple subjects in tandem. We sought to fulfill this need by taking advantage of the molecular basis of bioluminescence. By making chemical modifications to the firefly luciferin small moelcule and conducting mutagenesis on the firefly luciferase enzyme we sought to create mutually orthogonal enzyme-substrate pairs. 
%TODO finish
